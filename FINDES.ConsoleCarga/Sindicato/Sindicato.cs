...
namespace FINDES.ConsoleCarga
{
    public class Sindicato
    {
        ...
        protected static string file = $"Sindicato_{DateTime.Now.ToShortDateString().Replace("/", "")}-{DateTime.Now.ToShortTimeString().Replace(":", "")}.csv";
        ...
        public static void Send(string method, bool onlyCargaInicial, bool testMode)
        {
            ...
            {
                ConsoleHelper.Log("");
                ConsoleHelper.Log("Processing > Sindicato > Started");
                ...
                var query = new QueryExpression(Fields.Sindicato.entityName);
                ...
                #region | PROCESS
                ConsoleHelper.ProcessQuery(method, query, fields, file, Fields.Sindicato.tableSQL, Fields.Sindicato.entityName);
                #endregion

                ConsoleHelper.Log("Processing > Sindicato > Finished");
            }
            catch (Exception ex)
            {
