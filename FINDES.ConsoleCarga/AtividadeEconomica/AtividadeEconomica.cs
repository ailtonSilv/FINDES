...
namespace FINDES.ConsoleCarga
{
    public class AtividadeEconomica
    {
        ...
        protected static string file = $"AtividadeEconomica_{DateTime.Now.ToShortDateString().Replace("/", "")}-{DateTime.Now.ToShortTimeString().Replace(":", "")}.csv";

        /// <summary>
        /// Export AtividadeEconomica
        /// </summary>
        ...
        public static void Send(string method, bool onlyCargaInicial, bool testMode)
        {
            ...
            {
                ConsoleHelper.Log("");
                ConsoleHelper.Log("Processing > AtividadeEconomica > Started");
                ...
                var query = new QueryExpression(Fields.AtividadeEconomica.entityName);
                ...
                #region | PROCESS
                ConsoleHelper.ProcessQuery(method, query, fields, file, Fields.AtividadeEconomica.tableSQL, Fields.AtividadeEconomica.entityName);
                #endregion

                ConsoleHelper.Log("Processing > AtividadeEconomica > Finished");
            }
            catch (Exception ex)
            {
