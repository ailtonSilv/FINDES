...
namespace Findes.CustomAction.ExtratorCRM
{
    ...
    {
        public string parametroExtrator = "ActionExtratorCRM_ProdutoPropostas";
        public string parametroExtratorDePara = "ActionExtratorCRM_DePara_ListaItens_ProdutoPropostas";
        public string[] modeloBase = { "Entidade", "DataAlteracaoRegistro", "Cnpj", "CodigoPropostaRegional", "CodigoProduto", "NomeProduto", "ProdutoNacionalRegional", "QuantidadeProduto", "DescricaoUnidadeMedida", "ValorProduto", "ValorTotalProduto" };
        /* Modelo XML
        -- ActionExtratorCRM_ProdutoPropostas
        <xml>
	        <Entidade crmname='quotedetail' />
	        ...
	        ismultilookup='false' />
	        <CodigoPropostaRegional crmname='quoteid' crmtype='entityreference' crmtypefield='id' />
        ...
        {
            List<ItemProdutoProposta> listResult = new List<ItemProdutoProposta>();
            ...
            foreach (Entity ett in collection.Entities)
            {
                try
                {
                    var item = new ItemProdutoProposta
                    {
                        NumeroLayout = (int)NumeroLayout.ProdutoProposta,
        ...
        public class Resultado
        {
            ...
            [DataMember]
            public List<ItemProdutoProposta> content { get; set; }
        }
        ...
        /// </summary>
        [DataContract]
        public class ItemProdutoProposta
        {
            /// <summary>
