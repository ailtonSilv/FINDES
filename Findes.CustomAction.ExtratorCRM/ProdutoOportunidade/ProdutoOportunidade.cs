...
{
    public class ProdutoOportunidade
    {
        public string parametroExtrator = "ActionExtratorCRM_ProdutoOportunidades";
        public string parametroExtratorDePara = "ActionExtratorCRM_DePara_ListaItens_ProdutoOportunidades";
        public string[] modeloBase = { "Entidade", "DataAlteracaoRegistro", "CodigoOportunidadeRegional", "CodigoProduto", "ProdutoNacionalRegional", "ValorProduto", "ValorTotalProduto", "QuantidadeProduto", "DescricaoUnidadeMedida" };
        /* Modelo XML
        <xml>
	        <Entidade crmname='opportunityproduct' />
	        <DataAlteracaoRegistro crmname='modifiedon' crmtype='datetime' />
	        <CodigoOportunidadeRegional crmname='opportunityid' crmtype='entityreference' crmtypefield='id' />
        ...
        {
            List<ItemProdutoOportunidade> listResult = new List<ItemProdutoOportunidade>();
            ...
            foreach (Entity ett in collection.Entities)
            {
                try
                {
                    var item = new ItemProdutoOportunidade
                    {
                        NumeroLayout = (int)NumeroLayout.ProdutoOportunidade,
        ...
        public class Resultado
        {
            ...
            [DataMember]
            public List<ItemProdutoOportunidade> content { get; set; }
        }
        ...
        /// </summary>
        [DataContract]
        public class ItemProdutoOportunidade
        {
            /// <summary>
